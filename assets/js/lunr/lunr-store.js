var store = [{
        ...
        "title": "口吐 bug",
        "excerpt":"甲：我们借这个机会给大家拜个早年。 乙：你等等吧你（拉扯状 甲：怎么了？ 乙：没听说过。现在这五月份，前不着村后不着店的怎么拜早年了？ 甲：这还用我说？ 乙：嚯？ 甲：这专栏说好月更的，你看看上回发是啥时候了？ 乙：别。我们同台说个相声怎么还扯到专栏呢？别跳戏行不？ 甲：这不叫跳戏，你告诉我，这专栏主要讲啥的？ 乙：元编程？ 甲：可不是，我们讲的不就是元相声嘛，相声演员当然得觉醒自己在讲相声的意识。 乙：还元相声呢。 甲：可不是嘛，我们元相声演员讲究五门功课。 乙：说学逗唱。诶不对，相声啥时候五门功课了？ 甲：还有一门魔法，这是我们元相声演员也要掌握的。 乙：「时间都去哪儿了，还没好好写好代码就老了」 甲：怎么还突然唱起来了？ 乙：这不是你说的魔法吗？ 甲：不是这个魔法。 乙：啊，那还是哪个魔法？ 甲：这你也好意思开元编程专栏，连魔法都不会？ 乙：哦是元编程的魔法。 甲：可不是嘛，写起元编程来都是魔法。 乙：不对啊，那元相声和这个魔法有什么关系？ 甲：说到这个元相声啊，来源于程序员工作时的一个传统。 乙：穿女装？ 甲：穿女装是怎么回事啊。虽然这个也是传统，但元相声是来源于「代码评审」 乙：啊，code review。 甲：可不是嘛，code review 的时候程序员互相讨论，慢慢就形成了一门曲艺，那就是元相声。 乙：哇，这可是个新谱系啊。 甲：没错，和什么传统三大家可不一样，独成一派，师承谭浩强，我们元相声 乙：喂喂喂，师承谭浩强？ 甲：怎么了？ 乙：谭浩强来说过相声？ 甲：不是，谭浩强虽然没说过相声，但其漏洞百出的教材为程序员贡献了无数的笑料，成为了元相声的鼻祖。 乙：Wat? 甲：虽然元相声还是个新门派，但为了能传承下去，我们还是动了不少脑经。 乙：哦？怎么还传承了？刚成立就遇到传承难题了？ 甲：唉，大环境如此啊，老板最近都让我别说什么元相声了，去当偶像，几个程序员成立个女团。 乙：哇，我看还是这个靠谱点。 甲：但我不乐意啊，为了有更多人听到和了解元相声，我最近在写一本专著。 乙：我猜猜，Ruby 元相声？ 甲：不是。 乙：Learn You a...","categories": [],
        "tags": ["瞎扯蛋","相声"],
        "url": "/2017/05/17/spit-bugs",
        "teaser": null
      },{
        "title": "量产型炮灰工程师",
        ...
        "title": "写在甲辰年末",
        "excerpt":"今天有朋友问我：「你居然没点评 DeepSeek，不习惯。」 好吧，看来大家还是喜欢看我大放厥词。 Deepseek R1 的论文1我上周就已经看了，当时是很震撼的。我看到那个 rule-based RL 的时候，真得有种 Aha 的感觉。一些人可能知道，受一些论文23的启发，我们在研发的系统广泛受益于 grammar-constrained sampling 下对 LLM 的调用的效果。但我也从来没有意识到过可以通过如此精巧得构造使得一个自监督的 RL 可以产生如此精妙的效果。但今天我想跳出纯学术角度来讨论一些问题。 我想我们应当确立一个基本的共识。Scaling Law4 和 Moore’s Law 一样，是一种结果而不是原因。科技的进步从来没有银色子弹。没有人会相信 Moore’s Law 会成立，大家不但知道晶体管密度不可能持续地翻倍下去，也知道计算机性能不可能持续地翻倍下去。但是无论是诸如 FinFET、Gate-All-Around 的半导体器件工艺的进步，或者像是 DUV、EUV、浸润式光刻等制造技术的进步，以及从微架构设计和体系结构出发的芯片设计水平的进步，是一代代人智慧和努力的结果让 Moore’s Law 看起来仍然成立。类似地，AI 水平的进步绝无可能是单纯依赖参数量、算力、数据集的进步。如果有人告诉你今天 AI 发展会逐渐停滞，因为互联网上所有数据集都被 AI 吃光了5，你不觉得可疑吗？如果一个人类有能力理解互联网上那么多数据，它会像这些 AI 一样笨吗？真的不是显而易见地，我们的方法出了什么问题吗？ 当然资本市场自有它自己的看法。虽然我不止一次公开说过，在我心目中 Sam Altman 就是个傻◯，但我不否认 Sam 是一位优秀的 CEO，资本市场对他的吹捧是他应得的。我认为问题的本质是政治问题。只要人类社会存在一天，就会有一天主义。归根究底是我们就无法避免对有限资源争夺的分配问题。Sam Altman 把 AI...","categories": [],
        "tags": ["AI"],
